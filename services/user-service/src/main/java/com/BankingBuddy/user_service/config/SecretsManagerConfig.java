...
public class SecretsManagerConfig {
    ...
    // CHANGED: Use CRM_USERS_DB_SECRET_NAME instead of RDS_SECRET_NAME
    @Value("${CRM_USERS_DB_SECRET_NAME:}")
    ...
    public DataSource dataSource() {
        // CHANGED: Check for CRM users secret name
        if (crmUsersDbSecretName == null || crmUsersDbSecretName.isEmpty()) {
            throw new RuntimeException("CRM_USERS_DB_SECRET_NAME is required in AWS environment");
        }
        ...
        try {
            ...
            GetSecretValueRequest request = GetSecretValueRequest.builder()
                    .secretId(crmUsersDbSecretName)  // CHANGED: Use CRM secret
                    .build();
            ...
            return DataSourceBuilder.create()
                    ...
                    .username(username)
                    .password(password)
                    .driverClassName("com.mysql.cj.jdbc.Driver")  // ADDED: Explicit driver
                    .build();
