...
output "environment_name" {
  ...
  value       = aws_elastic_beanstalk_environment.transaction_service.name
}

output "application_name" {
  description = "Name of the EB application"
  value       = aws_elastic_beanstalk_application.transaction_service.name
}

output "endpoint_url" {
  description = "Full endpoint URL"
  value       = "http://${aws_elastic_beanstalk_environment.transaction_service.cname}"
}