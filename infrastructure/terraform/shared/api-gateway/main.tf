...
resource "aws_api_gateway_deployment" "main" {
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      aws_api_gateway_method.ai_options.id,
      ...
      aws_api_gateway_integration.clients_options.id,
      aws_api_gateway_integration.accounts_options.id,
      aws_api_gateway_integration.users_proxy_options.id,
      ...
      aws_api_gateway_integration.ai_options.id,
      ...
      aws_api_gateway_method_response.clients_options.id,
      aws_api_gateway_method_response.accounts_options.id,
      aws_api_gateway_method_response.users_proxy_options.id,
      ...
      aws_api_gateway_method_response.ai_options.id,
      ...
      aws_api_gateway_integration_response.clients_options.id,
      aws_api_gateway_integration_response.accounts_options.id,
      aws_api_gateway_integration_response.users_proxy_options.id,
      ...
      aws_api_gateway_integration_response.ai_options.id,
      ...
      aws_api_gateway_method.accounts_any.id,
      ...
      aws_api_gateway_integration.accounts_any.id,
      ...
      aws_api_gateway_method_response.accounts_any.id,
      ...
      aws_api_gateway_integration_response.accounts_any.id,
      ...
      # Accounts service
      aws_api_gateway_method_response.accounts_any_4xx.id,
      aws_api_gateway_method_response.accounts_any_5xx.id,
      aws_api_gateway_method_response.accounts_proxy_any_4xx.id,
      aws_api_gateway_method_response.accounts_proxy_any_5xx.id,
      aws_api_gateway_integration_response.accounts_any_4xx.id,
      aws_api_gateway_integration_response.accounts_any_5xx.id,
      aws_api_gateway_integration_response.accounts_proxy_any_4xx.id,
      aws_api_gateway_integration_response.accounts_proxy_any_5xx.id,
  ...
  depends_on = [
    ...
    aws_api_gateway_method.clients_options,
    ...
    aws_api_gateway_method.ai_options,
    ...
    aws_api_gateway_integration.ai_options,
    ...
    aws_api_gateway_method_response.clients_options,
    ...
    aws_api_gateway_method_response.ai_options,
    ...
    aws_api_gateway_integration_response.ai_options,
